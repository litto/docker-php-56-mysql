...
*/
	$user=$_GET['id'];
$values =   array('start'=>$start,'limit'=>$limit,"filter"=>$filter,"keyword"=>$keyword,"ord"=>$ord,"mode"=>$mode,'user'=>$user);
...
<form name="companysearch" method="post" enctype="multipart/form-data" action="loglist.php">
...
<?php  for($i=0;$i<count($records);$i++){  ?>
  ...
  <input type="hidden" name="id<?php echo $i;?>" value="<?php echo $records[$i]['id'];?>" />
											<td>
											<?php echo $records[$i]['logdate']; ?>
											</td>
											<td>
							<?php echo $ip=$records[$i]['ip']; ?>
</td>
...
?>
												...
												<td>
<?php echo $dt['country'];  ?></td>
											<td>
								<?php echo $records[$i]['activity']; ?>
</td>
									...
									<div class="pagination pull-right no-margin">
										<ul>
											<li class="prev disabled">
												<a href="loglist.php?start=<?php echo $first;?>&keyword=<?php echo $keyword;?>&filter=<?php echo $filter;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>&id=<?php echo $_GET['id']; ?>">
 ...
 <?php for($i=0;$i<count($pages);$i++){ 
                        $star   =   ($pages[$i]-1)*$limit;  ?>
											<li <?php if($start==$star){?> class="active" <?php }?>>
												<a href="loglist.php?start=<?php echo $star;?>&keyword=<?php echo $keyword;?>&filter=<?php echo $filter;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>&id=<?php echo $_GET['id']; ?>"><?php echo $pages[$i];?></a>
											</li>
  <?php }?>
										

											<li class="next">
												<a href="loglist.php?startadd=<?php echo $last;?>&keyword=<?php echo $keyword;?>&filter=<?php echo $filter;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>&id=<?php echo $_GET['id']; ?>">
			...
			<?php  for($i=0;$i<count($records);$i++){           ?>
				$( "#id-btn-dialog<?php echo $records[$i]['id']; ?>" ).on('click', function(e) {
					...
					$( "#dialog-confirm" ).dialog({
						resizable: false,
						modal: true,
						title: "<div class='widget-header'><h4 class='smaller'><i class='icon-warning-sign red'></i>Delete Activity?</h4></div>",
						title_html: true,
						buttons: [
							{
								...
								click: function() {
									$('.article').load("del_activity.php?id="+<?php echo $records[$i]['id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
				...
				$( "#id-btn-unpublish<?php echo $records[$i]['id']; ?>" ).on('click', function(e) {
					...
					$( "#unpublish-confirm" ).dialog({
						resizable: false,
						modal: true,
						title: "<div class='widget-header'><h4 class='smaller'><i class='icon-warning-sign red'></i>UnPublish Activity?</h4></div>",
						title_html: true,
						buttons: [
							{
								...
								"class" : "btn btn-danger btn-mini",
								click: function() {
									$('.article').load("unpublish_activity.php?id="+<?php echo $records[$i]['id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
				...
				$( "#id-btn-publish<?php echo $records[$i]['id']; ?>" ).on('click', function(e) {
					...
					$( "#publish-confirm" ).dialog({
						resizable: false,
						modal: true,
						title: "<div class='widget-header'><h4 class='smaller'><i class='icon-warning-sign red'></i>Publish Activity?</h4></div>",
						title_html: true,
						buttons: [
							{
								...
								"class" : "btn btn-danger btn-mini",
								click: function() {
									$('.article').load("publish_activity.php?id="+<?php echo $records[$i]['id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
