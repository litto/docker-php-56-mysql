...
if(isset($_POST['unpublish'])){
    ...
    header("Location:debtlist.php?acttab=1");
    exit;
}
/*
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Enquiry Listings</li>
...
<form name="companysearch" method="post" enctype="multipart/form-data" action="debtlist.php">
...
<th class="hidden-480">Debtor Name</th>
...
<?php  for($i=0;$i<count($records);$i++){  ?>
  ...
  <input type="hidden" name="id<?php echo $i;?>" value="<?php echo $records[$i]['id'];?>" />
											...
											<?php echo $records[$i]['name']; ?>
													...
													<td>
											<?php echo $records[$i]['mail']; ?>
											</td>
											
<td class="hidden-480"><?php echo $records[$i]['debtor_name']; ?></td>
...
<?php } ?>
											...
											<td>
												<div class="hidden-phone visible-desktop action-buttons">
													...
													<a class="btn btn-default" href="viewdebt.php?id=<?php echo $records[$i]['id']; ?>" title="Edit" >
														View
													</a>
												...
												<div class="hidden-desktop visible-phone">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
															...
															<li>
																<a href="viewdebt.php?id=<?php echo $records[$i]['id']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit" >
																	<span class="green">
									...
									<div class="pagination pull-right no-margin">
										<ul>
											<li class="prev disabled">
												<a href="debtlist.php?start=<?php echo $first;?>&keyword=<?php echo $keyword;?>&filter=<?php echo $filter;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>">
 ...
 <?php for($i=0;$i<count($pages);$i++){ 
                        $star   =   ($pages[$i]-1)*$limit;  ?>
											<li <?php if($start==$star){?> class="active" <?php }?>>
												<a href="debtlist.php?start=<?php echo $star;?>&keyword=<?php echo $keyword;?>&filter=<?php echo $filter;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>"><?php echo $pages[$i];?></a>
											</li>
  <?php }?>
										

											<li class="next">
												<a href="debtlist.php?startadd=<?php echo $last;?>&keyword=<?php echo $keyword;?>&filter=<?php echo $filter;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>">
						...
						buttons: [
							{
								...
								click: function() {
									$('.article').load("del_debt.php?id="+<?php echo $records[$i]['id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
						...
						buttons: [
							{
								...
								"class" : "btn btn-danger btn-mini",
								click: function() {
									$('.article').load("unpublish_debt.php?id="+<?php echo $records[$i]['id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
						...
						buttons: [
							{
								...
								"class" : "btn btn-danger btn-mini",
								click: function() {
									$('.article').load("publish_debt.php?id="+<?php echo $records[$i]['id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
