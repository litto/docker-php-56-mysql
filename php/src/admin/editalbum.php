...
$id=$_GET['id'];
$prd=new Album();
$record=$prd->getalbumdetails($id);

?><!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>WYDEINFO.com | Edit Album| </title>
...
if(isset($_POST["saveForm"])){
    ...
    */
    ...
    $albumTitle     =   trim($_POST['albumname']);
    $id=$_POST['id'];
    ...
    */  
    if(trim($albumTitle)=='' ){
        ...
        */
        $obj    =   new Album();
        $inputs =   array('album_title'=>$albumTitle,'id'=>$id);
        if($obj->editalbum($inputs)){
            $message    =   new Message('Album Edited ','message');
            $message->setMessage();
...
function reset(){
	document.getElementById("addproduct").reset();
        ...
        ?>
							...
							<form class="form-horizontal" name="addproduct" id="addproduct" method="post" enctype="multipart/form-data" action="editalbum.php?id=<?php echo $_GET['id'];?>">
								<div class="control-group">
									<label class="control-label" for="form-field-1">Album name</label>

									<div class="controls">
										<input type="text" placeholder="Album Name"  name="albumname" value="<?php echo $record[0]['album_title']; ?>"/>
									</div>
								</div>
