...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>WYDEINFO.com| Edit Photo</title>
...
$uploader->setSequence('gal');
$uploader->setMaxSize(2);

if($uploader->uploadFile("txtbrandFile")){
                /*
                 * File uploader successfully , now store to Db
                */
                $image     =   $uploader->getUploadName(); 
                $ins=array('photoname'=>$photoname,'image'=>$image,'id'=>$id);
             
            $usbrand->editgalleryimage($ins);
            }else{

$ins=array('photoname'=>$photoname,'id'=>$id);
$usbrand->editgallery($ins);
}

   $message    =   new Message('Photo edited successfully','message');
      $message->setMessage();
...
?>
        ...
        ?>
							...
							<form class="form-horizontal" name="editbrand" method="post" enctype="multipart/form-data" action="editphoto.php?id=<?php echo $_GET['id']; ?>&albumid=<?php echo $albumid; ?>">
...
<input type="hidden" name="albumid" value="<?php echo $_GET['albumid']; ?>" />
		...
		<div class="control-group" >
									<label class="control-label" for="form-field-1">Photo name</label>

									<div class="controls">
										<input type="text" id="newbrand" value="<?php echo $res[0]['image_title']; ?>" name="photoname"  />
										<span id="companyerror"> </span>
									</div>
								</div>
<div class="control-group" id="optbrand">
									<label class="control-label" for="form-field-1">Photo Preview</label>

									<div class="controls">
								<img src="thumb.php?file=../uploads/<?php echo $res[0]['image_loc']; ?>&size=150px" width="150px" height="150px"/>
									</div>
								</div>
			...
			<div class="control-group">
					<div class="row-fluid">
								<div class="span5">	<label class="control-label" for="form-field-1">Upload File</label>

									<div class="controls">

										<input type="file" id="id-input-file-2" name="txtbrandFile"/>
									</div></div>
								</div>
								</div>
