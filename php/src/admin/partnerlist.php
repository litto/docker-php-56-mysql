...
<html lang="en">
	...
	<head>
		...
		<title>Admin |Debt Listings</title>
...
if(isset($_POST['unpublish'])){
    ...
    header("Location:partnerlist.php?acttab=1");
    exit;
}
/*
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Partner Listings</li>
...
<form name="companysearch" method="post" enctype="multipart/form-data" action="partnerlist.php">
...
<td class="hidden-480"><?php echo $records[$i]['mobile']; ?></td>
<td class="hidden-480"><?php echo $records[$i]['comment']; ?></td>
<td class="hidden-480"><?php if($records[$i]['type']==0){ echo "Associate"; } else{ echo "Referrer"; }

?></td>
<td class="hidden-480"><?php echo $records[$i]['date_add']; ?></td>
...
<?php } ?>
											...
											<td>
												<div class="hidden-phone visible-desktop action-buttons">
													...
													<a class="btn btn-default" href="../uploads/<?php echo $records[$i]['doc']; ?>" target="_blank" title="Edit" >
														Download
													</a>
												...
												<div class="hidden-desktop visible-phone">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
															...
															<li>
																<a href="../uploads/<?php echo $records[$i]['doc']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit" >
																	<span class="green">
									...
									<div class="pagination pull-right no-margin">
										<ul>
											<li class="prev disabled">
												<a href="partnerlist.php?start=<?php echo $first;?>&keyword=<?php echo $keyword;?>&filter=<?php echo $filter;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>">
 ...
 <?php for($i=0;$i<count($pages);$i++){ 
                        $star   =   ($pages[$i]-1)*$limit;  ?>
											<li <?php if($start==$star){?> class="active" <?php }?>>
												<a href="partnerlist.php?start=<?php echo $star;?>&keyword=<?php echo $keyword;?>&filter=<?php echo $filter;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>"><?php echo $pages[$i];?></a>
											</li>
  <?php }?>
										

											<li class="next">
												<a href="partnerlist.php?startadd=<?php echo $last;?>&keyword=<?php echo $keyword;?>&filter=<?php echo $filter;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>">
						...
						buttons: [
							{
								...
								click: function() {
									$('.article').load("del_partner.php?id="+<?php echo $records[$i]['id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
						...
						buttons: [
							{
								...
								"class" : "btn btn-danger btn-mini",
								click: function() {
									$('.article').load("unpublish_partner.php?id="+<?php echo $records[$i]['id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
						...
						buttons: [
							{
								...
								"class" : "btn btn-danger btn-mini",
								click: function() {
									$('.article').load("publish_partner.php?id="+<?php echo $records[$i]['id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
