...
if(isset($_POST["saveForm"])){
    ...
    */  
    if(trim($txtTitle)==''){
        ...
        */
        $obj    =   new Bannerpage();
        $inputs =   array('title'=>$txtTitle,'image'=>$image,'published'=>$radPublish);
        if($obj->addNews($inputs)){
            $message    =   new Message('Banner content added ','message');
            $message->setMessage();
...
function reset(){
	...
	<body>
        ...
        ?>
							...
							<form class="form-horizontal" name="addproduct" id="addproduct" method="post" enctype="multipart/form-data" action="addbanner.php">
...
<div class="control-group" >
									...
									<div class="controls">
										<input type="text" id="newbrand" placeholder="Name" name="txtTitle"  value="<?php $_POST["txtTitle"];?>" />
