...
if(isset($_POST["saveForm"])){
    ...
    */  
    if(trim($footer)=='' || $seokeyword=='' ){
        ...
        */
        $obj    =   new Contacts();
        $inputs =   array('footer'=>$footer,'seo'=>$seokeyword);
        if($obj->updateseo($inputs)){
            $message    =   new Message('Content updated ','message');
            $message->setMessage();
        }else{
...
Contact Settings						
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<form class="form-horizontal" name="addproduct" id="addproduct" method="post" enctype="multipart/form-data" action="seo.php">
								
								<div class="control-group">
									<label class="control-label" for="form-field-1">SEO Keyword</label>

									<div class="controls">
										<textarea name="seokeyword" class="col-xs-10 col-sm-5" id="seokeyword"><?php echo $record[0]['seo'];  ?></textarea>
									</div>
								</div>

							
	<div class="control-group">
									<label class="control-label" for="form-field-1">Footer</label>

									<div class="controls">
										 <textarea name="footer" id="description" rows="5" cols="80"><?php echo $record[0]['footer'];  ?></textarea>
									</div>
								</div>
