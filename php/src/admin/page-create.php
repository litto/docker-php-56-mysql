...
if(isset($_POST["saveForm"])){
    ...
    */  
    if(trim($txtMenu)=='' || trim($txtParent)=='' || trim($txtTitle)=='' || trim($txtContent)==''){
        ...
        */
        ...
        $options    =   array(  'order'=>$order,'level'=>$level,'title'=>$txtMenu,
                                            'published'=>$radPublish,'pageTitle'=>$txtTitle,
                                            'content'=>$txtContent1,'parent'=>$txtParent,'position'=>$txtPosition,'slug'=>$slug,'seo_title'=>$seo_title,'seo_keywords'=>$seo_keywords,'seo_description'=>$seo_description);
        
                
        if($obj->addContent($options)){ //successfully added , set messge queue]
            $message    =   new Message('Content added successfully','message');
            $message->setMessage();     
            ...
            */
            ...
            $id         =   $obj->getInsert(); //last item inserted//
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<div class="row-fluid">
<form class="form-horizontal" id="addproduct" name="addproduct" method="post" enctype="multipart/form-data" action="page-create.php">
								<div class="control-group">
									<label class="control-label" for="form-field-1">Title</label>

									<div class="controls">
										<input type="text" id="searchprod" placeholder="Page Name"  name="txtMenuTitle" value="<?php echo $_POST['txtTitle'];?>"/>
									</div>
								</div>
...
<div class="control-group">
									...
									<div class="controls">
<input type="text" id="companyname" placeholder="Page Title" name="txtTitle"  value="<?php echo $_POST['txtTitle']; ?>" />
...
<div class="control-group">
									...
									<div class="controls">
<input type="text" id="companyname" placeholder="URL Slug" name="slug"  value="<?php echo $_POST['slug']; ?>" />
										<span id="companyerror"> </span>
		...
		<textarea name="seo_title" id="seo_title" rows="5" cols="80"><?php echo $_POST['seo_title'];?></textarea>
		...
		<textarea name="seo_keywords" id="form-field-tags" rows="5"   placeholder="SEO Keywords" cols="140"><?php echo $_POST['seo_keywords'];?></textarea>
					...
					<div class="control-group">
								...
								<textarea name="seo_description" id="seo_description" rows="5" cols="80"><?php echo $_POST['seo_description'];?></textarea>
			...
			<div class="control-group">
								...
								<textarea name="txtContent" id="description" rows="5" cols="80"><?php echo $_POST['txtContent'];?></textarea>
