...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>WYDEINFO.com| Add Album</title>
...
if(isset($_POST["saveForm"])){
    ...
    */  
    if(trim($albumTitle)=='' ){
        ...
        */
        $obj    =   new Album();
        $inputs =   array('album_title'=>$albumTitle);
        if($obj->addalbum($inputs)){
            $message    =   new Message('New album added ','message');
            $message->setMessage();
...
function reset(){
	...
	<body>
        ...
        ?>
							...
							<form class="form-horizontal" name="addproduct" id="addproduct" method="post" enctype="multipart/form-data" action="addalbum.php">
								<div class="control-group">
									<label class="control-label" for="form-field-1">Album Name</label>

									<div class="controls">
										<input type="text"  placeholder="Album Title"  name="albumTitle" value="<?php echo $_POST['albumTitle']; ?>"/>
									</div>
								</div>
