...
$insert=array('productname'=>$productname,'price'=>$price,'unit'=>$unit,'productimage'=>$productimage,'description'=>$description,'adddate'=>$adddate,'viewcount'=>'100','ip'=>$ip,'publish'=>$publish,'type'=>$type,'order'=>$order,'parent'=>$parent,'level'=>$level);
$k=$pr->addproduct($insert);

$lastid=$pr->lastInsertId();
...
$pr->addattributes($attributename,$attributedescription,$lastid);
...
$pi->addimage($lastid,$nm,$image,$adddate,$ip);
   ...
   $message    =   new Message('Product added successfully','message');
      $message->setMessage();
      ?>
...
<form class="form-horizontal" id="addproduct" name="addproduct" method="post" enctype="multipart/form-data" action="addproduct.php">
								<div class="control-group">
									<label class="control-label" for="form-field-1">Product Name</label>

									<div class="controls">
										<input type="text" id="searchprod" placeholder="Product Name"  name="productname" value="<?php echo $_POST['productname']; ?>"/>
									</div>
								</div>

							<div class="control-group">
					<div class="row-fluid">
								<div class="span5">	<label class="control-label" for="form-field-1">Product Image</label>
						...
						<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="companyname" placeholder="Price in AED" name="price" value="<?php echo $_POST['price']; ?>" />
				...
				<div class="control-group">
							...
							<select class="chosen-select" id="form-field-select-4" data-placeholder="Choose type" name="type">
										...
										<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Select type" title="Help">?</span>
...
<option value="<?php echo $prdet[$i]['id']; ?>"> <?php echo $prdet[$i]['name']; ?></option>
...
<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="price3" placeholder="Order" name="order" value="<?php echo $_POST['order']; ?>" />
										<span id="companyerror"> </span>
									</div>
								</div>
...
<div class="control-group">
			...
			<div class="control-group">
								...
								<textarea name="description" id="description" rows="5" cols="80"><?php echo $_POST['description']; ?></textarea>
