...
<html lang="en">
	...
	<head>
		...
		<title>Admin |Album Listings</title>
...
/*if(isset($_POST['upload'])){
    ...
    $absDirName =   dirname(dirname(__FILE__)).'/siteimages/banner';
    $relDirName =   '../siteimages/banner';
    ...
    if($uploader->uploadFile("txtFile")){
        ...
        */
        ...
        $obj    =   new Content();
        $obj->addBanner(array('image'=>$image));
        $message    =   new Message('Successfully Added','message');
        $message->setMessage();
...
if(isset($_POST['delete'])){
    ...
    header("Location:albumlisting.php");
    exit;
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Album Listings</li>
...
<form name="companysearch" method="post" enctype="multipart/form-data" action="albumlisting.php">
...
<div class="row-fluid">
	<div class="span7">&nbsp;</div>
								<div class="span5">
										...
										<a href="addalbum.php"  class="btn btn-app btn-primary btn-small">
...
<?php  for($i=0;$i<count($records);$i++){  ?>
										...
										<tr>
											<td class="center">
												<label>
													<input type="checkbox" class="ace" name="chkId<?php echo $i;?>" id="chkId<?php echo $i;?>" value="<?php echo $records[$i]['album_id'];?>" />
													<span class="lbl"></span>
												</label>
											</td>
  <input type="hidden" name="id<?php echo $i;?>" value="<?php echo $records[$i]['album_id'];?>" />
											<td>
											<?php echo $records[$i]['album_title']; ?>
											</td>
...
<?php } ?>
				...
				<td> <a  href="imagelisting.php?id=<?php echo $records[$i]['album_id']; ?>" title="Edit" class="btn btn-primary">
													Add Images</a>
</td>
											...
											<td>
												<div class="hidden-phone visible-desktop action-buttons">
													...
													<a class="green" href="editalbum.php?id=<?php echo $records[$i]['album_id']; ?>" title="Edit" >
													...
													<a class="red" href="#" title="Delete"  id="id-btn-dialog<?php echo $records[$i]['album_id']; ?>">
														<i class="icon-trash bigger-130"></i>
													</a>
                                            

														<a class="green" href="#" title="Publish" id="id-btn-publish<?php echo $records[$i]['album_id']; ?>">
														<i class="icon-eye-open bigger-130"></i>
													</a>
															<a class="red" href="#" title="Unpublish" id="id-btn-unpublish<?php echo $records[$i]['album_id']; ?>">
												...
												<div class="hidden-desktop visible-phone">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
															...
															<li>
																<a href="editalbum.php?id=<?php echo $records[$i]['album_id']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit" >
																	<span class="green">
															...
															<li>
																<a href="#" class="tooltip-error" data-rel="tooltip" title="Delete" id="id-btn-dialog<?php echo $records[$i]['album_id']; ?>">
																	<span class="red">
                                                    	...
                                                    	<li>
																<a href="#" class="tooltip-success" data-rel="tooltip" title="Publish" id="id-btn-publish<?php echo $records[$i]['album_id']; ?>">
																	<span class="green">
                                                         	...
                                                         	<li>
																<a href="#" class="tooltip-error" data-rel="tooltip" title="Unpublish" id="id-btn-unpublish<?php echo $records[$i]['album_id']; ?>">
																	<span class="red">
									...
									<div class="pagination pull-right no-margin">
										<ul>
											<li class="prev disabled">
												<a href="albumlisting.php?start=<?php echo $first;?>&keyword=<?php echo $keyword;?>&parent=<?php echo $parent;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>">
 ...
 <?php for($i=0;$i<count($pages);$i++){ 
                        $star   =   ($pages[$i]-1)*$limit;  ?>
											<li <?php if($start==$star){?> class="active" <?php }?>>
												<a href="albumlisting.php?start=<?php echo $star;?>&keyword=<?php echo $keyword;?>&parent=<?php echo $parent;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>"><?php echo $pages[$i];?></a>
											</li>
  <?php }?>
										

											<li class="next">
												<a href="albumlisting.php?start=<?php echo $last;?>&keyword=<?php echo $keyword;?>&parent=<?php echo $parent;?>&ord=<?php echo $ord;?>&mode=<?php echo $mode;?>">
...
<script type="text/javascript">
		...
		jQuery(function($) {
			...
			<?php  for($i=0;$i<count($records);$i++){           ?>
				$( "#id-btn-dialog<?php echo $records[$i]['album_id']; ?>" ).on('click', function(e) {
					e.preventDefault();
				
					$( "#dialog-confirm" ).dialog({
						resizable: false,
						modal: true,
						title: "<div class='widget-header'><h4 class='smaller'><i class='icon-warning-sign red'></i>Delete Album?</h4></div>",
						title_html: true,
						buttons: [
							{
								...
								click: function() {
									$('.article').load("del_album.php?id="+<?php echo $records[$i]['album_id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
				...
				<?php } ?>
						...
						<?php  for($i=0;$i<count($records);$i++){           ?>
				$( "#id-btn-unpublish<?php echo $records[$i]['album_id']; ?>" ).on('click', function(e) {
					e.preventDefault();
				
					$( "#unpublish-confirm" ).dialog({
						resizable: false,
						modal: true,
						title: "<div class='widget-header'><h4 class='smaller'><i class='icon-warning-sign red'></i>UnPublish Album?</h4></div>",
						title_html: true,
						buttons: [
							{
								...
								"class" : "btn btn-danger btn-mini",
								click: function() {
									$('.article').load("unpublish_album.php?id="+<?php echo $records[$i]['album_id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
				...
				<?php  for($i=0;$i<count($records);$i++){           ?>
				$( "#id-btn-publish<?php echo $records[$i]['album_id']; ?>" ).on('click', function(e) {
					e.preventDefault();
				
					$( "#publish-confirm" ).dialog({
						resizable: false,
						modal: true,
						title: "<div class='widget-header'><h4 class='smaller'><i class='icon-warning-sign red'></i>Publish Album?</h4></div>",
						title_html: true,
						buttons: [
							{
								...
								"class" : "btn btn-danger btn-mini",
								click: function() {
									$('.article').load("publish_album.php?id="+<?php echo $records[$i]['album_id'];  ?>);
									$( this ).dialog( "close" );
								}
							}
							,
