...
<meta property="og:title" content="Become a Referrer - Global Debt Collection And Recovery. Corporate, Civil, Family Litigation and Legal Help.
mail us at:- info@uaedebtcollection.com">
<meta property="og:description" content="Become a Referrer - Global Debt Collection And Recovery. Corporate, Civil, Family Litigation and Legal Help.
mail us at:- info@uaedebtcollection.com">
...
if($name==''|| $mail==''){
header("Location:become_referrer.php?msg=Enter mandatory Fields");
}else{
...
$par=new Partners();
$insert=array('name'=>$name,'email'=>$mail,'mobile'=>$cell,'comment'=>$comments,'doc'=>$image,'type'=>'1','status'=>'0');
...
$subject = "Become a Referrer: UAE Debt Collection";
...
<tr>
<td>
<p>A Referrer Request has been submitted in Uaedebtcollection.com with below details. Please Check:-</p>
</td>
</tr>
<tr>
...
header("Location:become_referrer.php?msg=Successfuly registered for a Referrer!!");
exit;
}
    ...
    header("Location:become_referrer.php?msg=Values mismatch");
    exit;
}
}
      ...
      <div class="row">  
        <div class="col-md-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Become a Referrer</li>
          </ol>
        </div>  
      </div> 
    </div> 
...
?></span>
                ...
                <div class="row">
                    <div class="col-md-12">
                                      <form class="form-light mt-20" role="form" action="become_referrer.php" method="post" enctype="multipart/form-data">
                                      <h4>Refer and get rewarded</h4>
                                      <p> If you want to be a partner with us, here is the opportunity you can grasp asap. Just refer clients or cases with us, you can get certain percentage reward according to the terms. Join today and our respresentatives will contact you.   </p>
